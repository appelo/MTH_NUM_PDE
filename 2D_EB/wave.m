...
for i = 1:nbp
    if (level(x(ghost_points(i,1)-1,ghost_points(i,2)),y(ghost_points(i,1)-1,ghost_points(i,2)))>0)
        ghost_points(i,3)=ghost_points(i,1)+1;
        ghost_points(i,4)=ghost_points(i,2);
    elseif (level(x(ghost_points(i,1)+1,ghost_points(i,2)),y(ghost_points(i,1)+1,ghost_points(i,2)))>0)
        ghost_points(i,3)=ghost_points(i,1)-1;
        ghost_points(i,4)=ghost_points(i,2);
    elseif (level(x(ghost_points(i,1),ghost_points(i,2)-1),y(ghost_points(i,1),ghost_points(i,2)-1))>0)
        ghost_points(i,3)=ghost_points(i,1);
        ghost_points(i,4)=ghost_points(i,2)+1;
    elseif (level(x(ghost_points(i,1),ghost_points(i,2)+1),y(ghost_points(i,1),ghost_points(i,2))+1)>0)
        ghost_points(i,3)=ghost_points(i,1);
        ghost_points(i,4)=ghost_points(i,2)-1;
    end
...
for  i = 1:nbp
    val=(ghost_points(i,1)==ghost_points(i,3));
    if(val==1)
